...
def main():
        ...
        alphabet.introSymbol('b', 'abrir')
        alphabet.introSymbol('c', 'abrir')
        for elem in alphabet.symbols:
            elementList.append(elem.value)
        er = ER('((a.b)+.a|a*.b.b?)', elementList)
        print(er.ERaPF(er))
main()
...
____88888888888888888888888__.;8'"___(888888
...
__(8888888I,______________________.__```"88888888P"
___88888888I,___________________,8I___8,_______I8"
_____"88888I,________________,8I'____"I8,____;8"
